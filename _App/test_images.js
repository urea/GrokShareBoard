...
async function test() {
    ...
    for (const uuid of uuids) {
        ...
        const urls = [
            `https://imagine-public.x.ai/imagine-public/share-videos/${uuid}_thumbnail.jpg`,
            `https://imagine-public.x.ai/imagine-public/share-videos/${uuid}.png`,
            `https://assets.grok.com/images/${uuid}.jpg`,
